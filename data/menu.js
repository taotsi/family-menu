globalThis.FAMILY_MENU = {
  ingredientTree: [
    ...
    },
    {
      ...
      children: [
        {
          name: "鱼",
          children: ["鲈鱼", "鲫鱼", "鳕鱼", "笋壳鱼", "小黄鱼", "昂刺鱼", "鱼头"],
        },
        {
          name: "虾",
          children: ["小河虾"],
  ...
  dishes: [
    ...
    { name: "广式蒸鸡", ingredients: ["肉类", "鸡肉"], methods: ["蒸"] },
    ...
    { name: "清炖鸡", ingredients: ["肉类", "鸡肉"], methods: ["炖"] },
    ...
    { name: "干菜烧昂刺鱼", ingredients: ["水产", "鱼", "昂刺鱼", "蔬菜", "干菜"], methods: ["烧"] },
    { name: "花椒蒸排骨", ingredients: ["肉类", "猪肉", "排骨"], methods: ["蒸"] },
    { name: "花椒蒸鸡", ingredients: ["肉类", "鸡肉"], methods: ["蒸"] },
    { name: "清炒空心菜", ingredients: ["蔬菜", "空心菜"], methods: ["炒"] },
    { name: "清炒菠菜", ingredients: ["蔬菜", "菠菜"], methods: ["炒"] },
    { name: "酸辣白菜", ingredients: ["蔬菜", "白菜"], methods: ["炒"] },
    { name: "酸辣豆芽", ingredients: ["蔬菜", "豆芽"], methods: ["炒"] },
  ],
};
